...
<nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<ul class="nav navbar-top-links navbar-left">
		...
		<li class="dropdown"><a class="dropdown-toggle"
			...
			<ul class="dropdown-menu dropdown-user">
				<li><a href="/posts/notice"> 전체공지</a></li>
				<li class="divider"></li>
				<li><a href="/posts/library_buksam"> 북삼도서관</a></li>
				<li><a href="#"> 게시판3</a></li>
			</ul> <!-- /.dropdown-user -->
		<!-- /.dropdown -->
	</ul>
	...
	<ul class="nav navbar-top-links navbar-left">
		<li class="dropdown"><a class="dropdown-toggle" href="#">게시판 검색 </a></li>
	</ul>
	<!-- /.navbar-top-links -->
	...
	<ul class="nav navbar-top-links navbar-right">
		...
		<li class="dropdown"><a class="dropdown-toggle"
			...
			<ul class="dropdown-menu dropdown-user">
				<li><a href="#"><i class="fa fa-smile-o fa-fw"></i> <sec:authentication property="principal.user.activityScore"/> Points</a></li>
				<li class="divider"></li>
